...
% Datos para la resolución de método de Bisección
funcion = 'cos(x)-x^3';
li = 0;
ls = 1;
tolerancia = 1e-5;
...
% Inicia el main.m
try
  fprintf('Solución método de Bisección \n\n')
  [iteraciones,convergencia,punto_de_raiz]=biseccion(funcion,li,ls,tolerancia)
catch error
  fprintf('Error: %s\n',error.message);
  %err.identifier
end
