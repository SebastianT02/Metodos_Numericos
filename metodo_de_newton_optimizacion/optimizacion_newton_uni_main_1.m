...
% Ejemplo 1:
% Se desea conocer el punto maximo en x y y de la siguiente funcion para 
...
% tiempo a otro se desea conocer el mejor punto, este valor de x es 2.5
% con un margen de tolerancia de 0.0001.

% Datos del ejercicio
clc,clear
syms x
funcion = '2*sin(x)-((x^2)/10)';  % Declaro la funcion a mostrar
funcion = str2sym(funcion); % Convierto la funcion en symbolica para entrar a la funcion
valor_x = 2.5;                % Valor inicial de la variable declarada x
